...
{{
  ...
  "main_complaints": [
    {{
      "title": "주요 불만 주제 (20자 이내)",
      "description": "이 불만에 대한 구체적 설명. 어떤 유저들이 왜 불편해하는지 (60자 이내)",
      "example_reviews": ["위 리뷰 목록에서 이 불만을 가장 잘 대표하는 실제 리뷰 문장을 그대로 발췌. 80자 이내로 잘라도 됨", "두 번째 대표 리뷰 문장"]
    }},
    {{"title": "주요 불만 주제 2", "description": "설명 2", "example_reviews": ["발췌 1", "발췌 2"]}},
    {{"title": "주요 불만 주제 3", "description": "설명 3", "example_reviews": ["발췌 1", "발췌 2"]}}
  ],
  "main_praises": [
    {{
      "title": "주요 칭찬 주제 (20자 이내)",
      "description": "이 칭찬에 대한 구체적 설명. 어떤 점이 왜 좋다고 하는지 (60자 이내)",
      "example_reviews": ["위 리뷰 목록에서 이 칭찬을 가장 잘 대표하는 실제 리뷰 문장을 그대로 발췌. 80자 이내로 잘라도 됨", "두 번째 대표 리뷰 문장"]
    }},
    {{"title": "주요 칭찬 주제 2", "description": "설명 2", "example_reviews": ["발췌 1", "발췌 2"]}},
    {{"title": "주요 칭찬 주제 3", "description": "설명 3", "example_reviews": ["발췌 1", "발췌 2"]}}
  ],
